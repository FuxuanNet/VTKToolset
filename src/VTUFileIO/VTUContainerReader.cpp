...
//		const QVector<float>& raw = it.value();
//		int compsPerNode = raw.size() / numNodes;
//
//		if (compsPerNode == 1) {
//			QVector<float> data(numNodes);
//			for (int i = 0; i < numNodes; ++i) data[i] = raw[i];
//			scalars[fieldName] = data;
//		}
//		else if (compsPerNode == 3) {
//			QVector<QVector3D> data(numNodes);
//			for (int i = 0; i < numNodes; ++i)
//				data[i] = QVector3D(raw[3 * i], raw[3 * i + 1], raw[3 * i + 2]);
//			vectors[fieldName] = data;
//		}
//	}
//}